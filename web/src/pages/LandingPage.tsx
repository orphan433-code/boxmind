...
const FEATURES = [
  {
    title: "Сохранение",
    text: "Вставь URL на сайте. Все ссылки остаются в одной библиотеке.",
  },
  {
    title: "Категории",
...
const STEPS = [
  {
    title: "Добавь ссылку",
    text: "Вставь URL в веб-приложении. Ссылка сразу попадает в твою библиотеку.",
  },
  {
...
const FAQ = [
  {
    ...
    answer:
      "Boxmind - веб-сервис для сохранения и организации ссылок. Он собирает закладки в одном месте, автоматически описывает страницы и помогает быстро возвращаться к нужному материалу. Подходит для работы, учёбы, чтения и личных подборок.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Сейчас Boxmind работает в браузере на компьютере и телефоне. Отдельное приложение для iPhone и расширение для Chrome пока в разработке и скоро появятся.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Сейчас Boxmind бесплатен для личного использования. Можно сохранять ссылки, пользоваться поиском и папками без оплаты и привязки карты.",
  },
] as const;
        ...
        <section className="landing-hero landing-shell" aria-labelledby="landing-hero-title">
          <div className="landing-hero-copy">
            ...
            <p className="landing-lead">
              {TAGLINE}. Сохраняй ссылки в веб-приложении, находи нужное без хаоса в заметках и
              вкладках.
            </p>
            {!token && (
